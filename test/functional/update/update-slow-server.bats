...
@test "update --download with a slow server" {
	...
	expected_output=$(cat <<-EOM
		...
		Downloading packs...
		Error for .*/update/update-slow-server/state/pack-test-bundle-from-10-to-100.tar download: Response 206 - No error
		Starting download retry #1 for .*100/pack-test-bundle-from-10.tar
		Error for .*/update/update-slow-server/state/pack-test-bundle-from-10-to-100.tar download: Response 200 - Requested range was not delivered by the server
